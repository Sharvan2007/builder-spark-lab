...
export function ScoreGauge({ score = 78, trend = 6 }: { score?: number; trend?: number }) {
  ...
  const gradientId = useMemo(() => `g-${Math.random().toString(36).slice(2)}`,[score]);
  ...
  return (
    <div className="relative grid place-items-center">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <div className="text-5xl font-extrabold text-white tabular-nums">{display}</div>
